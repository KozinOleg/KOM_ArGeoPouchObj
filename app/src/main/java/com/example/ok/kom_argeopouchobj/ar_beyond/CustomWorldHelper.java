...
public class CustomWorldHelper {
	...
	public static World generateObjects(Context context) {
		...
		sharedWorld.setDefaultImage(R.drawable.fire_touched_image);
		...
		go1.setImageResource(R.drawable.androidmarker);
